...
export function stageColor(stage: string | null): string {
  switch (stage) {
    case 'Qualification': return 'border-gray-400 bg-gray-50 text-gray-600';
    case 'Cultivation': return 'border-gray-500 bg-gray-50 text-gray-700';
    case 'Solicitation': return 'border-amber-500 bg-amber-50 text-amber-700';
    case 'Negotiation': return 'border-amber-600 bg-amber-50 text-amber-800';
    case 'Stewardship': return 'border-forest-700 bg-forest-50 text-forest-700';
...
export function stagePipelineColor(stage: Stage): string {
  const colors: Record<Stage, string> = {
    Qualification: 'border-l-gray-400',
    Cultivation: 'border-l-gray-500',
    Solicitation: 'border-l-amber-500',
    Negotiation: 'border-l-amber-700',
    Stewardship: 'border-l-forest-700',
  };
