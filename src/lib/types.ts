...
export type Stage = 'Ready for Invitation' | 'Prayerful Discernment' | 'Needs Further Cultivation' | 'Strategic Connector' | 'Given';
...
export const STAGES: Stage[] = ['Ready for Invitation', 'Prayerful Discernment', 'Needs Further Cultivation', 'Strategic Connector', 'Given'];
